  ...
  return (
    <div>
      <div className=' mt-10 p-10 ml-10'>
        <h2 className=' text-blue-400 mb-5'>Before You start</h2>
        <h1 className=' text-orange-300  text-4xl font-bold'>Our service that supports a true <br /> competitive bidding process</h1>
      </div>
      <div className=' feature-card'>
      <div className="h-full min-h-screen w-full pt-12 p-4">
  <div className="grid gap-14 md:grid-cols-3 md:gap-5">
    <Link href={'CreateEvent'} className="rounded-xl bg-white p-6 text-center shadow-xl">
      <div
      ...
      <h1 className="text-darken mb-3 text-xl font-medium lg:px-14">Events creation and managment</h1>
    ...
    <Link href={"/Donation"} data-aos-delay="150" className="rounded-xl bg-white p-6 text-center shadow-xl">
      <div
      ...
      <h1 className="text-darken mb-3 text-xl font-medium lg:px-14 ">Development &  Donation</h1>
      <p className="px-4 text-gray-500">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quo iure inventore amet
        modi
        accusantium vero perspiciatis, incidunt dicta sed aspernatur!</p>
    </Link>
    <Link href={'/'} data-aos-delay="300" className="rounded-xl bg-white p-6 text-center shadow-xl">
      <div
